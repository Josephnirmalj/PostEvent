$(document).ready(function(e) {
	...
	function assignValues(decUserDetails){
		...
		$("#lastName-jp").val(splitArray[1]);
		$("#firstName-jp").val(splitArray[0]);
		$("#emailAddress-jp").val(splitArray[2]);
		$("#busPh-jp").val(splitArray[3]);
		$("#company-jp").val(splitArray[4]);
		$("#jobTitle-jp").val(splitArray[5]);
		$("#comments-jp").val(splitArray[10]);
	}
	...
	//scroll to top for related articles
		...
		$("#btn-submit-jp").on("click",function(){
			...
			if(lname == ""){
				errMsg = errMsg +"ln";
				$("#errlastName-jp").text("Enter your last name");
			}
			else{
				$("#errlastName-jp").text(" ");
			}
			...
			if(errMsg == ""){
				...
				var userDetails = fname+","+lname+","+email+","+busPhone+","+company+","+jobTitle+","+country+","+clickSrcTitle+","+clickSrcCat+","+regionalUpdate+","+comments;
				var encodeDetails = encodeURIComponent(userDetails);
				document.cookie="userDetails="+encodeDetails+";expires="+newdate+";path=/";
				formsubmitForJp(fname,lname,email,busPhone,company,jobTitle,country,clickSrcTitle,clickSrcCat,regionalUpdate,comments);
		...
		function formsubmitForJp(fname,lname,email,busPhone,company,jobTitle,country,clickSrcTitle,clickSrcCat,regionalUpdate,comments)
		{
