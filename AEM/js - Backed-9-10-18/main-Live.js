$(document).ready(function(e) {
	...
	$( window ).resize(function() {
		...
		function ajaxFormSubmit(artCatogrey,artTitle){
			...
			var totalPDFDownlaod = parseInt(videoCookie)+parseInt(articleCookie);
			...
			var data = "emailAddress="+visiorEmail+"&assetName="+artTitle+"&assetCatogrey="+artCatogrey+"&viewedVideos="+viewVideoCookie+"&formSubmits="+totalPDFDownlaod+"&webVisit="+pageViewCount+"&relatedArticles="+relatedArticles;
			$.ajax({
				url:url,
				type: "POST",
				data:data,
			...
			if(relatedArticles == ""){
				...
				if(errmsg == ""){
					var url = "//s2502.t.eloqua.com/e/f2?elqFormName="+eloquaFormName+"&elqSiteID="+SiteID+"&";
					var data="emailAddress="+email+"&optin="+optin+"&viewedVideos="+videoCookie+"&formSubmits="+articleCookie+"&webVisit="+pageViewCount+"&relatedArticles="+relatedArticles;
					$.ajax({
				url:url,
				type: "POST",
				data:data,
